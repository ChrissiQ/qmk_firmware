...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, MV_SCRN, XXXXXXX,                      XXXXXXX, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, XXXXXXX,\
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
...
const uint16_t PROGMEM cut_combo[] = {KC_Z, KC_M, COMBO_END};
const uint16_t PROGMEM paste_combo[] = {KC_M, KC_C, COMBO_END};
const uint16_t PROGMEM undo_combo[] = {KC_Z, KC_X, COMBO_END};
const uint16_t PROGMEM redo_combo[] = {KC_X, KC_C, COMBO_END};
const uint16_t PROGMEM all_combo[] = {KC_Z, KC_C, COMBO_END};
const uint16_t PROGMEM save_combo[] = {KC_Q, KC_D, COMBO_END};

combo_t key_combos[COMBO_COUNT] = {
  [XM_COPY] = COMBO_ACTION(copy_combo),
  [ZM_CUT] = COMBO_ACTION(cut_combo),
  [MC_PASTE] = COMBO_ACTION(paste_combo),
  [ZX_UNDO] = COMBO_ACTION(undo_combo),
  [XC_REDO] = COMBO_ACTION(redo_combo),
  [ZC_ALL] = COMBO_ACTION(all_combo),
  [QD_SAVE] = COMBO_ACTION(save_combo),
};
